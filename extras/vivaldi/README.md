# Abysal for Vivaldi Browser

The Abysal theme collection for Vivaldi browser. Includes day, moon, night, and storm variants.
...
2. Copy a theme JSON file (e.g., `abysal_marble.json`) to this directory
3. Rename it to `settings.json`
4. Zip the file: 

   ```bash
   zip abysal_marble.zip settings.json`
   ```
