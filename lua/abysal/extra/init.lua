...
function M.setup()
  local abysal = require("abysal.theme")
  ...
  for _, extra in ipairs(names) do
    ...
    local plugin = require("abysal.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = abysal.setup({ style = style, plugins = { all = true } })
      local fname = extra
      ...
      colors["_style_name"] = "Abysal" .. style_name
      colors["_name"] = "abysal_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
