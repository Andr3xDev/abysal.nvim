...
function M.get(c)
  -- stylua: ignore
  return {
    BufferAlternate        = { bg = c.fg_muted, fg = c.fg },
    BufferAlternateADDED   = { bg = c.fg_muted, fg = c.git.add },
    BufferAlternateCHANGED = { bg = c.fg_muted, fg = c.git.change },
    BufferAlternateDELETED = { bg = c.fg_muted, fg = c.git.delete },
    BufferAlternateERROR   = { bg = c.fg_muted, fg = c.error },
    BufferAlternateHINT    = { bg = c.fg_muted, fg = c.hint },
    BufferAlternateINFO    = { bg = c.fg_muted, fg = c.info },
    BufferAlternateIndex   = { bg = c.fg_muted, fg = c.info },
    BufferAlternateMod     = { bg = c.fg_muted, fg = c.warning },
    BufferAlternateSign    = { bg = c.fg_muted, fg = c.info },
    BufferAlternateTarget  = { bg = c.fg_muted, fg = c.gold },
    BufferAlternateWARN    = { bg = c.fg_muted, fg = c.warning },
    ...
    BufferCurrentTarget    = { bg = c.bg, fg = c.gold },
    BufferCurrentWARN      = { bg = c.bg, fg = c.warning },
    BufferInactive         = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = Util.blend_bg(c.fg_secondary, 0.8) },
    ...
    BufferInactiveIndex    = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.fg_secondary },
    ...
    BufferInactiveTarget   = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.gold },
    BufferInactiveWARN     = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = Util.blend_bg(c.warning, 0.8) },
    BufferOffset           = { bg = c.bg_statusline, fg = c.fg_secondary },
    BufferTabpageFill      = { bg = Util.blend_bg(c.bg_highlight, 0.8), fg = c.fg_secondary },
    ...
    BufferVisibleTarget    = { bg = c.bg_statusline, fg = c.gold },
