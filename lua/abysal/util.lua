...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("abysal.hsluv")
    if color ~= "NONE" then
...
---@param groups abysal.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/abysal-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, abysal.Cache
